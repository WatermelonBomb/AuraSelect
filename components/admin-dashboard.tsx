      ...
      <div className="container mx-auto p-6 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 gold-gradient rounded-2xl flex items-center justify-center luxury-shadow">
          ...
          <Button
            ...
            className="border-2 border-yellow-200 hover:bg-yellow-50 font-medium px-6 py-3 rounded-xl bg-transparent"
          >
            顧客画面へ戻る
          </Button>
        </div>
        ...
        <Tabs defaultValue="products" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-white/80 backdrop-blur-sm border-2 border-yellow-100 rounded-2xl p-2 luxury-shadow">
            <TabsTrigger
              value="products"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-yellow-400 data-[state=active]:to-yellow-500 data-[state=active]:text-white rounded-xl font-medium py-3"
            >
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <Button
                  ...
                  className="gold-gradient hover:opacity-90 text-white font-semibold px-6 py-3 rounded-xl luxury-shadow"
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          >
                            <SelectTrigger className="border-2 border-yellow-200 focus:border-yellow-400 rounded-xl">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          rows={3}
                          className="border-2 border-yellow-200 focus:border-yellow-400 rounded-xl resize-none"
                        />
                      </div>
                      ...
                      <div className="flex gap-4">
                        <Button
                          type="submit"
                          className="gold-gradient hover:opacity-90 text-white font-semibold px-8 py-3 rounded-xl luxury-shadow"
                        >
          ...
          <TabsContent value="analytics" className="mt-8">
            <Card className="glass-effect luxury-shadow-lg border-0 rounded-3xl">
              <CardContent className="p-12 text-center">
                <div className="w-20 h-20 gold-gradient rounded-full flex items-center justify-center mx-auto mb-6 luxury-shadow">
